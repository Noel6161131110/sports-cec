...
from .views import AddEvent,CreateParticipation,ConfirmParticipationSelect,StudentReport,Disqualify,EventReport,TrackCard,FieldCard,SelectYear, YearlyReport
...
path('selectyear/', SelectYear.as_view(), name='selectyear'),
path('yearlyreport/', YearlyReport.as_view(), name='yearlyreport'),
]
